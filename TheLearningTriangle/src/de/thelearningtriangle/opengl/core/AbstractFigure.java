...
public abstract class AbstractFigure implements DrawableFigure
{
    ...
    /**
     * This function adds the angle to the overall rotation of
     * this object
     * @param angle
     */
    ...
    /**
     * This function returns a value between 0 and 359
     * This value represents the rotation of this figure
     * @return
     */
    ...
    private float[][] calculateRotatedTriangle()
    {
        ...
        for (int i = 0; i < rotatedVectors.length; i++)
        {
            ...
            newVector[0] = (float) (vector[0] * Math.cos(Math.toRadians(getRotationAngle()))) - (float) (vector[1] * Math.sin(Math.toRadians(getRotationAngle())));
            newVector[1] = (float) (vector[0] * Math.sin(Math.toRadians(getRotationAngle()))) + (float) (vector[1] * Math.cos(Math.toRadians(getRotationAngle())));
            newVector[2] = 0.0f;
