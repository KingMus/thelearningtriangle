...
/**
 * @author Noixes
 * This class is a implementation from {@code AbstractFigure}
 * for drawing a Triangle
 * it implements some transformation-features such as rotate, move in direction
 */
public class LearningTriangleFigure extends AbstractFigure
{
    ...
    /**
     * Initializes a drawable learning triangle
     * with starting position of parameters posX and posY
     * @param posX
     * @param posY
     */
    ...
    /**
     * @author Noixes
     * This Method defines the shape of the learning triangle 
     * and returns a vector with the standard x and y positions
     * On position (0|0) the nose-point is drawn
     * (It is also the beginning of the triangle)
     */
